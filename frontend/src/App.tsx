            ...
            <tbody>
              {calendar?.map((entry: any) => (
                <tr key={entry.id} className="border-b border-ink/5 text-sm">
                  ...
                  <td className="py-3">
                    {entry.isHoliday ? (
                      <span className="rounded-full bg-guvi-orange/10 text-guvi-orange px-2 py-1 text-xs font-semibold">Holiday</span>
                    ) : (

                ...
                <tr key={user.id} className="border-b border-ink/5 text-sm">
                  ...
                  <td className="py-3 pr-4 text-right">
                    <button 
                      ...
                      className="text-coral hover:underline text-xs font-semibold"
                    >
                      Remove
                    </button>
                  </td>
            ...
            <tbody>
              {calendar?.map((entry: any) => (
                <tr key={entry.id} className="border-b border-ink/5 text-sm">
                  ...
                  <td className="py-3">
                    {entry.isHoliday ? (
                      <span className="rounded-full bg-coral/10 text-coral px-2 py-1 text-xs font-semibold">Holiday</span>
                    ) : (
